...
events <- readRDS(here::here("prepped", "events_col_noofficial_hex25.rds")) %>%
...
saveRDS(df_s_t_trunc, here::here("prepped", "events_decay_col_noofficial_hex25_logistic_trunc.rds"))
