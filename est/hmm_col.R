...
events <- readRDS(here::here("prepped","events_decay_col_hex25_logistic_trunc.rds"))
...
# For Colombia: no prior of who controls what territory.
# Note that estimation begins in 1997
...
saveRDS(hmm_grid, here::here("prepped","hmm_col.rds"))
